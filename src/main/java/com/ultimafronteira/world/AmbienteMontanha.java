...
=======
        super(nome, descricao, "Difícil", "Frio e Ventoso");
...
=======
        adicionarRecurso(new Material("Pedra Afiada", 1.0, "Mineral", 6));
        adicionarRecurso(new Material("Minério de Ferro Bruto", 2.5, "Metal", 7));
        adicionarRecurso(new Agua("Água de Degelo", 0.5, 1, 5, "Contaminada", 0.5));
>>>>>>> f7209b58956d6d2fcbc7f29dfcf96ffd5093dbcd
    }
...
=======
        ...
        if (jogador.temHabilidade("Rastreamento Aguçado")) {
            chanceBaseRecurso += 0.15; // Bônus menor em ambiente difícil
>>>>>>> f7209b58956d6d2fcbc7f29dfcf96ffd5093dbcd
